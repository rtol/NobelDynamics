%This script puts together the data for the Nobel memorial network over time.
%
...
F(2) = getframe(hfig);
%%
s0 = {'Simon Kuznets (1971)' 'Wesley Clair Mitchell' 'John Dewey' 'John Dewey' 'John Dewey' 'John Dewey' 'George Morris' 'Wesley Clair Mitchell' 'Wesley Clair Mitchell' 'Laurence Laughlin'};
p0 = {'Wesley Clair Mitchell' 'John Dewey' 'Charles Peirce' 'George Morris' 'Granville Hall' 'Herbert Adams' 'Friedrich Trendelenburg' 'Thorstein Veblen' 'Laurence Laughlin' 'Henry Adams'};
...
s5 = {'Herbert Adams' 'Herbert Adams'};
p5 = {'Karl Knies' 'Johann Bluntschli'};
...
F(10) = getframe(hfig);
%%
s = {'Theodore Schultz (1979)' 'Benjamin Hibbard' 'Richard Ely' 'Richard Ely' 'Arthur Lewis (1979)' 'Arnold Plant'};
p = {'Benjamin Hibbard' 'Richard Ely' 'Karl Knies' 'Johann Bluntschli' 'Arnold Plant' 'Edwin Cannan'};
...
s2 = {'William Sharpe (1990)' 'William Sharpe (1990)' 'William Sharpe (1990)' 'Armen Alchian' 'Allen Wallis' 'Fred Weston'};
p2 = {'Fred Weston' 'Harry Markowitz (1990)' 'Armen Alchian' 'Allen Wallis' 'Harold Hotelling' 'Frank Knight'};
...
F(23) = getframe(hfig);
%%
s = {'Gary Becker (1992)' 'Gary Becker (1992)' 'Gregg Lewis'};
p = {'Milton Friedman (1976)' 'Gregg Lewis' 'Henry Schultz'};
...
F(32) = getframe(hfig);
%%
s0 = {'George Akerlof (2001)' 'Michael Spence (2001)' 'Thomas Schelling (2005)' 'Thomas Schelling (2005)' 'Thomas Schelling (2005)' 'James Duesenberry' 'Arthur Smithies' 'Joseph Stiglitz (2001)' 'Frank Hahn' 'Frank Hahn' 'Nicholas Kaldor' 'Nicholas Kaldor' 'Joseph Stiglitz (2001)'};
p0 = {'Robert Solow (1987)' 'Thomas Schelling (2005)' 'Wassily Leontief (1973)' 'James Duesenberry' 'Arthur Smithies' 'Arthur Smithies' 'Joseph Schumpeter' 'Frank Hahn' 'Lionel Robbins' 'Nicholas Kaldor' 'Lionel Robbins' 'Allyn Abbott Young' 'Joan Robinson'};

s1 = {'Michael Spence (2001)' 'Michael Spence (2001)' 'Richard Zeckhauser'};
p1 = {'Kenneth Arrow (1972)' 'Richard Zeckhauser' 'Thomas Schelling (2005)'};
...
F(37) = getframe(hfig);
%%
s = {'Edmund Phelps (2006)' 'Edmund Phelps (2006)' 'Edmund Phelps (2006)' 'Edmund Phelps (2006)' 'Arthur Okun'};
p = {'James Tobin (1981)' 'William Fellner' 'Thomas Schelling (2005)' 'Arthur Okun' 'Arthur Burns'};
...
F(40) = getframe(hfig);
%%
s0 = {'Oliver Williamson (2009)' 'Oliver Williamson (2009)' 'Richard Cyert' 'Richard Cyert' 'Arthur Burns'};
p0 = {'Richard Cyert' 'Herbert Simon (1978)' 'George Stigler (1982)' 'Arthur Burns' 'Wesley Clair Mitchell'};
...
F(43) = getframe(hfig);
%%
s = {'Lloyd Shapley (2012)' 'Alvin Roth (2012)' 'Robert Wilson (2020)' 'Howard Raiffa' 'Arthur Copeland' 'Oliver Kellogg' 'David Hilbert' 'Ferdinand Lindemann' 'Felix Klein' 'Felix Klein' 'Felix Klein' 'Rudolf Lipschitz'};
p = {'Albert Tucker' 'Robert Wilson (2020)' 'Howard Raiffa' 'Arthur Copeland' 'Oliver Kellogg' 'David Hilbert' 'Ferdinand Lindemann' 'Felix Klein' 'Rudolf Lipschitz' 'Julius Pluecker' 'Rudolf Clebsch' 'Gustav Dirichlet'};
...
p = {'Robert Wilson (2020)' 'Michael Rothshield' 'Robert Solow (1987)' 'Peter Diamond (2010)' 'Franklin Fisher' 'John Meyer'};
...
%%
s = {'William Nordhaus (2018)' 'Paul Romer (2018)' 'Paul Romer (2018)' 'Jose Scheinkman' 'Lionel McKenzie' 'Lionel McKenzie' 'William Baumol' 'Oskar Morgenstern'  'Oskar Morgenstern' 'Hans Mayer' 'Gary Becker (1992)'};
p = {'Robert Solow (1987)' 'Robert Lucas (1995)' 'Jose Scheinkman' 'Lionel McKenzie' 'William Baumol' 'Oskar Morgenstern' 'Lionel Robbins' 'Ludwig von Mises' 'Hans Mayer' 'Friedrich von Wieser'  'William Baumol'};
...
hfig = figure;
if names
    plot(G50,'Layout',layout,'NodeLabel',G50.Nodes.Name);
else
     plot(G50,'Layout',layout,'NodeLabel',{});
end
title('2018: Nordhaus and Romer');
set(gcf,'units','points','position',[0,0,960,720])
xticklabels({}); yticklabels({});xticks([]);yticks([]);
F(50) = getframe(hfig);

%%
s = {'Esther Duflo (2019)' 'Esther Duflo (2019)' 'Esther Duflo (2019)' 'Joshua Angrist (2021)' 'Joshua Angrist (2021)' 'David Card (2021)' 'Orley Ashenfelter' 'Orley Ashenfelter' 'Stephen Goldfeld' 'Albert Ando'  'Abhijit Banerjee (2019)' 'Michael Kremer (2019)' 'Robert Barro' 'Zvi Griliches' 'Zvi Griliches' 'Abhijit Banerjee (2019)' 'Dipak Banerjee' 'Richard Lipsey'};
p = {'Joshua Angrist (2021)' 'Abhijit Banerjee (2019)' 'Michael Kremer (2019)' 'Orley Ashenfelter' 'David Card (2021)' 'Orley Ashenfelter' 'Albert Rees' 'Stephen Goldfeld' 'Albert Ando' 'Franco Modigliani (1985)' 'Eric Maskin (2007)' 'Robert Barro' 'Zvi Griliches' 'Theodore Schultz (1979)' 'Arnold Harberger' 'Dipak Banerjee' 'Richard Lipsey' 'James Meade (1977)'};
...
hfig = figure;
if names
    plot(G51,'Layout',layout,'NodeLabel',G51.Nodes.Name);
else
     plot(G51,'Layout',layout,'NodeLabel',{});
end
title('2019: Banerjee, Duflo and Kremer');
set(gcf,'units','points','position',[0,0,960,720])
xticklabels({}); yticklabels({});xticks([]);yticks([]);
F(51) = getframe(hfig);
%%
s = {'Paul Milgrom (2020)'};
p = {'Robert Wilson (2020)'};
...
hfig = figure;
if names
    plot(G52,'Layout',layout,'NodeLabel',G52.Nodes.Name);
else
     plot(G52,'Layout',layout,'NodeLabel',{});
end
title('2020: Milgrom and Wilson');
set(gcf,'units','points','position',[0,0,960,720])
xticklabels({}); yticklabels({});xticks([]);yticks([]);
F(52) = getframe(hfig);
...
F(53) = getframe(hfig);
%%
s0 = {'Ben Bernanke (2022)'};
p0 = {'Stanley Fischer'};

s1 = {'Stanley Fischer'};
p1 = {'Franklin Fisher'};

s2 = {'Douglas Diamond (2022)'};
p2 = {'Stephen Ross'};

s3 = {'Philip Dybvig (2022)'};
p3 = {'Stephen Ross'};
...
hfig = figure;
if names
    plot(G54,'Layout',layout,'NodeLabel',G54.Nodes.Name);
else
     plot(G54,'Layout',layout,'NodeLabel',{});
end
title('2022: Bernanke, Diamond and Dybvig');
set(gcf,'units','points','position',[0,0,960,720])
xticklabels({}); yticklabels({});xticks([]);yticks([]);
F(54) = getframe(hfig);

%%
s0 = {'Claudia Goldin (2023)'};
p0 = {'Robert Fogel (1993)'};
...
hfig = figure;
if names
    plot(G55,'Layout',layout,'NodeLabel',G55.Nodes.Name);
else
     plot(G55,'Layout',layout,'NodeLabel',{});
end
title('2023: Goldin');
set(gcf,'units','points','position',[0,0,960,720])
xticklabels({}); yticklabels({});xticks([]);yticks([]);
...
%%
s0 = {'Simon Johnson (2024)'};
p0 = {'Rudiger Dornbusch'};

s1 = {'Daron Acemoglu (2024)' 'Kevin Roberts' 'Andrei Shleifer' 'Andrei Shleifer' 'Kenneth Rogoff'};
p1 = {'Kevin Roberts' 'James Mirrlees (1996)' 'Peter Diamond (2010)' 'Franklin Fisher' 'Rudiger Dornbusch'};

s2 = {'James Robinson (2024)' 'Truman Bewley' 'Truman Bewley' 'Calvin Moore' 'George Mackey' 'Marshall Stone'};
p2 = {'Truman Bewley' 'Calvin Moore' 'Gerard Debreu (1983)' 'George Mackey' 'Marshall Stone' 'George Birkhoff'};
...
hfig = figure;
if names
    plot(G56,'Layout',layout,'NodeLabel',G56.Nodes.Name);
else
     plot(G56,'Layout',layout,'NodeLabel',{});
end
title('2024: Acemoglu, Johnson and Robinson');
set(gcf,'units','points','position',[0,0,960,720])
xticklabels({}); yticklabels({});xticks([]);yticks([]);
F(56) = getframe(hfig);
...
s1 = {'Gary Becker (1992)' 'Gary Becker (1992)' 'Gary Becker (1992)' 'Gary Becker (1992)'};
p1 = {'Milton Friedman (1976)' 'Henry Schultz' 'Aaron Director' 'Leonard Savage'};

s2 = {'Leonard Savage' 'Leonard Savage' 'Leonard Savage' 'Sumner Myers' 'Marston Morse'};
p2 = {'Sumner Myers' 'Milton Friedman (1976)' 'Allen Wallis' 'Marston Morse' 'George Birkhoff'};
...
s8 = {'Oskar Morgenstern'};
p8 = {'Ludwig von Mises'};

s9 = {'Franco Modigliani (1985)'};
p9 = {'Abba Lerner'};

G54alt = addedge(G54,p,s);
G54alt = rmedge(G54alt,[p6 p7 p8 p9],[s6 s7 s8 s9]);
